        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    {!! Form::open(['route' => 'branch.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'container']) !!}
                    ...
                    <div>
                        ...
                        {{ Form::select('location', \App\Models\Location::pluck('name', 'id'), null, ['class' => 'block mt-1 rounded-md shadow-sm border-gray-300']) }}
                    </div>
